                ...
                <div class="admin-dropdown" id="adminDropdown">
                    <div class="admin-profile">
                        <div class="admin-avatar-container">
                            <img src="https://via.placeholder.com/45" alt="Admin" class="admin-avatar">
                        </div>
                    ...
                    <div class="admin-dropdown-content" id="adminDropdownContent">
                        <div class="admin-dropdown-header">
                            <div class="admin-dropdown-avatar-container">
                                <img src="https://via.placeholder.com/60" alt="Admin" class="admin-dropdown-avatar">
                            </div>
                        ...
                        <div class="admin-dropdown-user">
                            ...
                            <p class="admin-dropdown-user-email">admin@techhub.com</p>
                        </div>
