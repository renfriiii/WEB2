...
<head>
    ...
    <title>Checkout - TechHub</title>    <link rel="icon" href="images/hf.png">
                                ...
                                <div class="payment-details" id="paymentDetails">
                                        ...
                                        <div class="e-wallet-details">
                                            ...
                                            <div class="wallet-info">
                                                ...
                                                <div class="wallet-account">
                                                    ...
                                                    <p>After sending payment, please take a screenshot of your receipt and send it to our email: payments@techHub.com</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="payment-detail-content" id="bankDetails" style="display: none;">
                                        <div class="bank-details">
                                            ...
                                            <p>After making the transfer, please take a screenshot of your receipt and send it to our email: payments@techHub.com</p>
                                        </div>
                                    </div>
                                </div>
