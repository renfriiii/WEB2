...
<body>
    ...
    <div class="slideshow-container">
        <div class="slideshow-slide active" style="background-image: url('images/summer4.webp');">
            <div class="slideshow-content">
                <h2>Summer Collection 2025</h2>
                <p>Discover our new breathable activewear for your summer workouts</p>
                <a href="#products" class="slideshow-btn">Shop Now</a>
            </div>
        </div>

        <div class="slideshow-slide" style="background-image: url('images/running-gear.jpg');">
            <div class="slideshow-content">
                <h2>30% Off Running Gear</h2>
                <p>Limited time offer on all premium running apparel</p>
                <a href="#products" class="slideshow-btn">View Collection</a>
            </div>
        </div>
        ...
        <div class="slideshow-slide" style="background-image: url('images/yoga-collection.jpg');">
            <div class="slideshow-content">
                ...
                <a href="#products" class="slideshow-btn">Explore</a>
            </div>
        </div>
